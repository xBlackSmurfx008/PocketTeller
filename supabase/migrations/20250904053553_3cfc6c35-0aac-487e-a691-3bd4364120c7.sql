-- Security hardening: Enable leaked password protection and improve auth settings
-- This protects against users setting compromised passwords

-- Add auth configuration improvements
INSERT INTO auth.config (parameter, value) VALUES 
  ('password_min_length', '12'),
  ('password_complexity_policy', 'mixed_case_numbers_symbols')
