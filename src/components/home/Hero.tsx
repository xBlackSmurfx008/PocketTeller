...
export const Hero: React.FC<HeroProps> = ({
  ...
  return <section className="relative min-h-[95vh] flex items-center justify-center bg-gradient-to-br from-background via-background to-muted/20 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-accent/8 rounded-full blur-3xl animate-float" style={{
        animationDelay: "2s"
      }} />
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="glass-container rounded-3xl p-12 md:p-16 text-center">
            ...
            {/* Subheadline */}
            <p className="typography-subtitle text-muted-foreground max-w-4xl mx-auto mb-14 animate-fade-in leading-relaxed" style={{
            animationDelay: "0.2s"
          }}>
            ...
            {/* Credibility Strip */}
            <div className="flex flex-wrap justify-center gap-12 mb-16 animate-fade-in" style={{
            animationDelay: "0.3s"
          }}>
              <div className="flex items-center text-muted-foreground group">
                ...
                <div className="text-left">
                  <div className="typography-body-lg font-semibold text-foreground stat-counter">5K+</div>
              ...
              <div className="flex items-center text-muted-foreground group">
                ...
                <div className="text-left">
                  ...
                  <div className="text-sm">Increased Savings</div>
                </div>
              </div>
              <div className="flex items-center text-muted-foreground group">
                <Star className="w-7 h-7 mr-4 text-accent group-hover:scale-110 transition-transform duration-300" />
                <div className="text-left">
                  <div className="typography-body-lg font-semibold text-foreground stat-counter">5/5</div>
            ...
            animationDelay: "0.5s"
              ...
              <ShadeButton intent="primary" size="lg" className="px-14 py-6 text-xl font-semibold rounded-2xl group" onClick={onGetStarted}>
                JOIN WAITLIST
                <ArrowRight className="ml-3 h-6 w-6 group-hover:translate-x-1 transition-transform duration-300" />
              </ShadeButton>
              <ShadeButton intent="secondary" size="lg" className="px-14 py-6 text-xl font-semibold rounded-2xl glass-container border-2" onClick={onTryDemo}>
                Try Live Demo
              </ShadeButton>
            </div>

            {/* Trust Indicators */}
            <div className="mt-14 pt-8 border-t border-border/30 animate-fade-in" style={{
            animationDelay: "0.7s"
          }}>
