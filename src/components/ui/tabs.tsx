...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-full bg-muted/40 p-1 backdrop-blur text-muted-foreground",
      className
    )}
    {...props}
  />
